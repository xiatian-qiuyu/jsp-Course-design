<%@ page import="com.huangmaohua.model.Product" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<!-- loop_start -->
						...
						<tr>
							...
							<%
								com.huangmaohua.model.Product p = (Product) pageContext.findAttribute("p");
								int pid = p.getProductId();
								Connection con = (Connection) application.getAttribute("con");
								String catName = com.huangmaohua.model.Category.findBycategoryId(con,pid);
							%>
