			...
			<table class="table table-condensed">
				...
				<c:forEach var="o" items="${orderList}">
					<tr>
						...
						<td>${o.orderDate}</td>
						<%
							com.huangmaohua.model.Order o=(com.huangmaohua.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.huangmaohua.dao.UserDao userDao=new com.huangmaohua.dao.UserDao();
						...
						<td class="cart_total">
							<%
								...
								String paymentType=com.huangmaohua.model.Payment.findByPaymentId(con,n);
							%>
